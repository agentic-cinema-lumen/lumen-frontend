  ...
  return <main className="app-shell">
    ...
    {view === 'brief' && <section className="studio-layout">
      <aside className="project-rail">
        ...
        <div className="cloud-proof"><span><WandSparkles /></span><p><b>Google-native stack</b>Gemini Enterprise<br />Vertex AI · BigQuery ML</p></div>
      </aside>
      <section className="studio-main">
        ...
        <div className="constellation-input">
          ...
          <div className="signal-strip"><span><i className="g-blue" /> Parallel agent analysis</span><span><i className="g-red" /> Evidence-linked reasoning</span><span><i className="g-yellow" /> Automated model calibration</span><span><i className="g-green" /> Confidence-aware output</span></div>
        </div>
